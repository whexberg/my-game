...
void InitResources()
{
	...
	TexturesToLoad.emplace_back("assets/colored_tilemap.png"); //TileSetTexture
	TexturesToLoad.emplace_back("assets/icons/Icon.5_46.png"); //LogoTexture
	...
	SoundsToLoad.emplace_back("assets/sounds/click3.ogg");
	SoundsToLoad.emplace_back("assets/sounds/handleCoins.ogg");
	SoundsToLoad.emplace_back("assets/sounds/doorOpen_1.ogg");
	SoundsToLoad.emplace_back("assets/sounds/metalPot1.ogg");
	SoundsToLoad.emplace_back("assets/sounds/creature1.ogg");
	SoundsToLoad.emplace_back("assets/sounds/woosh4.ogg");
	SoundsToLoad.emplace_back("assets/sounds/knifeSlice2.ogg");
	SoundsToLoad.emplace_back("assets/sounds/chop.ogg");
	SoundsToLoad.emplace_back("assets/sounds/creature5.ogg");
	SoundsToLoad.emplace_back("assets/sounds/powerUp2.ogg");
